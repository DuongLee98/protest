...
contract Teacher
{
    ...
    function addUser(string u, string pw, string n, string p, string ic) public payable
    {
        require(!userExist(u));
        data[u].pass = pw;
        data[u].name = n;
    ...
    function editUser(string u, string pw, string n, string p, string ic) public payable
    {
        require(userExist(u));
        data[u].pass = pw;
        data[u].name = n;
    ...
    function setIcUser(string u, string ic) public payable
    {
        require(userExist(u));
        data[u].ic = ic;
    }
    ...
    function getIcUser(string u) public view returns (bool, string, string)
    {
        if (userExist(u) == false)
            return (false, "User doesn't exist", "");
        return (true, "Success", data[u].ic);
    }
